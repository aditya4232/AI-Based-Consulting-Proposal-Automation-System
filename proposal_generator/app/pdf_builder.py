...
class ProposalPDF(FPDF):
    ...
    def footer(self):
        ...
        self.cell(0, 5, self._safe(f"Page {self.page_no()}/{{nb}}  |  Confidential - ProposalAI"), align="C")
    ...
    def cover_page(self, proposal_data: dict):
        ...
        self.set_font("Helvetica", "B", 9)
        self.set_text_color(96, 165, 250)
        self.cell(210, 8, self._safe("Generated by ProposalAI - AI-Powered Consulting Automation"), align="C")
...
def build_proposal_pdf(proposal_data: dict) -> str:
    ...
    pdf.multi_cell(
        ...
        "Generated by ProposalAI on " + __import__("datetime").date.today().strftime("%B %d, %Y") + ".",
        align="C",
    )
